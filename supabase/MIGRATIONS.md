...
| 018 | `018_empleado_documentos.sql` | 2026-07-21 | Feature: tabla `empleado_documentos` + bucket privado de Storage `empleados-documentos` — subida real de cédula/hoja de vida/contrato PDF/certificados/otros por empleado, reemplaza los flags booleanos sin archivo real de `empleados.doc_*` (migración 007) | ⏳ Pendiente de ejecutar en Supabase |
